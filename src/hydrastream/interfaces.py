...
class StorageBackend(Protocol):
    ...
    async def write_chunk_data(
        self, fd_or_conn: Any, data: bytearray, offset: int) -> None ...
    ...
    def load_state(self, filename: str) -> tuple[File | None, int]:
        """Пытается загрузить прогресс. Возвращает
        (File, количество_найденных_стейтов)"""
        ...

    def delete_state(self, filename: str) -> None:
        """Удаляет стейт после успешного скачивания"""
        ...
